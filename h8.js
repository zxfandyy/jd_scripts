/*
 燃动夏季百元红包通知
 0,1,15,30 8 * * * summer_notify.js
 */
const $ = new Env("燃动夏季百元红包通知");
      ...
      switch (type) {
        case 2:
          taskBody = `functionId=olympicgames_assist&body=${JSON.stringify({
            ...
            type: "confirm",
            ss: log,
          })}&client=wh5&clientVersion=1.0.0&appid=${$.appid}`;
          break;
        case 1:
          taskBody = `functionId=olympicgames_assist&body=${JSON.stringify({
            inviteId: $.inviteId,
